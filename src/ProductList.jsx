...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        // Only dispatch if the item isn't already in cart
        if (!isItemInCart(product.name)) {
            // Dispatch action to add item to cart
            dispatch(addItem(product));

            // Update local state to show that item has been added
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {cartItems.length > 0 && (
                                    <span className="cart_quantity_count">{cartItems.reduce((total, item) => total + (item.quantity || 1), 0)}</span>
                                )}
                            </h1>
                        </a>
                    </div>
                                ...
                                <div className="product-card" key={plantIndex}>
                                    ...
                                    <button 
                                        ...
                                        style={{
                                            ...
                                            opacity: isItemInCart(plant.name) ? 0.7 : 1
                                        }}
                                    >
